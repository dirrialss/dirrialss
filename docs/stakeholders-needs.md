...
**Expert-O-Matic** — має дві категорії користувачів: клієнти та експерти.  

👥 **Клієнти** — це люди, які створюють опитування та на основі відповідей отримують статистику й аналіз даних. Вони можуть:  
...
👨‍💻 **Експерти** — це користувачі, які отримують опитування та проходять їх. Вони можуть:  
