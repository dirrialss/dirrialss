...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | EX.01.01 Акаунт із вказаною електронною адресою вже зареєстрований. EX.01.02 Обов’язкові поля форми залишилися незаповненими. EX.01.03 Введений пароль не відповідає мінімальним критеріям безпеки. EX.01.04 Введені значення в полі "Пароль" та "Підтвердження пароля" не ідентичні. |
...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | EX.01.05 Введені нові дані не відповідають встановленим правилам. EX.01.06 Неправильно введено поточний пароль, необхідний для підтвердження змін. |
...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | EX.01.06 Неправильне введення пароля при спробі підтвердити видалення профілю |
...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | EX.01.07 Не всі поля заповнено — питання або варіанти відповідей мають порожні значення. EX.01.08 У запитанні вказано ідентичні варіанти відповідей. EX.01.09 У створеному опитуванні відсутні питання. |
...
| **ВИКЛЮЧНІ СИТУАЦІЇ** | EX.02.02 Користувач двічі натискає кнопку видалення до завершення обробки першого запиту. EX.02.03 При підтвердженні наміру видалити опитування обрано опцію "Ні". |
